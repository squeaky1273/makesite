...
[![Go Report Card](https://goreportcard.com/badge/github.com/squeaky1273/makesite)](https://goreportcard.com/report/github.com/squeaky1273/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the google translate library. The documentation is located at github.com/bas24/googletranslatefree. My goal is to use it to translate text pages into different languages.`
- [x] **Add, commit, and push to GitHub**.
